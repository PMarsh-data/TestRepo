...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            style={'width':0.80, 'padding':'3px', 'font-size':'20px', 'text-align-last':'center'}
        )
    ]),
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
        ...
        Y_chart3 = dcc.Graph( figure=px.bar(avr_vdata, y='Automobile_Sales',x='Year',title='Average Vehicles Sold by Vehicle Type in the year {}'.format(input_year)))
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, values = 'Advertising_Expenditure', names = 'Vehicle_Type', title = 'Total Advertising Expenditure Share by Vehicle Type')
